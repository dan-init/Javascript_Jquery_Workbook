$(function() {                                                      //on DOM loaded
    ...
    $('#price-range').slider({                                      //Turn price-range input into a slider
        range: true,                                                //If it is a range it gets two handles (min/max)
        min: 0,                                                     //Minimum value
    ...
    $amount                                                         //Set intitial values of amount element
        .val('$' + $range.slider('values', 0)                       //A $ symbol then the lower range
        + ' - $' + $range.slider('values', 1));                     //A $ symbol then the higher range.
