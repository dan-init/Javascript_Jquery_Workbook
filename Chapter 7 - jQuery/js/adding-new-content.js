$(function() {
    ...
    var $newLitstItem = $('<li><em>gluten-free</em> soy sauce</li>');   //Store new <li> tag in a variable, get last <li> tag, 
    $('li:last').after($newLitstItem);                                  //.after() method add the new <li> variable after the last <li> tag. 
});